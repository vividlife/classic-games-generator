    ...
    <>
      ...
      <main className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
          ...
          <Link
            href="/reversi"
            className="group relative bg-slate-800 rounded-2xl p-8 border border-slate-700 hover:border-teal-500/50 hover:bg-slate-800/80 transition-all duration-200 cursor-pointer"
          >
            <div className="text-6xl mb-4">⬛</div>
            ...
            <div className="flex gap-2 text-xs">
              <span className="bg-teal-900/50 text-teal-300 px-2 py-1 rounded">
                双人对战
              </span>
              <span className="bg-slate-700 text-slate-300 px-2 py-1 rounded">
                落子提示
